...
public class ArticleDao {
	...
	public ArticleDao() {
		...
		Article a1 = new Article(1, "안녕하세요", "내용1", "홍길동", getCurrentDate());
		Article a2 = new Article(2, "반갑습니다.", "내용2", "박지성", getCurrentDate());
		Article a3 = new Article(3, "안녕", "내용3", "손흥민", getCurrentDate());
